...
indicator <-  read.csv('THB211_currency_indicator.csv',stringsAsFactors = FALSE)
...
write.csv(as.data.frame(data_after), file = "THB211_currency_interpolated.csv",row.names=TRUE)
write.csv(result, file = "THB211_currency_result_table.csv",row.names=TRUE)
