...
indicator <-  read.csv('INR266_currency_indicator.csv',stringsAsFactors = FALSE)
...
index <- read.csv('INR266_currency.csv',stringsAsFactors = FALSE)
...
write.csv(as.data.frame(data_after), file = "INR266_currency_interpolated.csv",row.names=TRUE)
write.csv(result, file = "INR266_currency_result_table.csv",row.names=TRUE)
