...
index <- read.csv("MYR209_index.csv",stringsAsFactors = FALSE)
...
jpeg(file = " MYR209 index LOESS plot %d.jpeg",quality=100,width = 1200, height = 800,units = 'px', pointsize = 12)
...
jpeg(file = "MYR209 index.jpeg",quality=100,width = 1200,height = 800,units = 'px', pointsize = 12)
...
plot.xts(t, screens = factor(1, 1), panel = custom.panel,auto.legend = TRUE, main = "MYR209 index", xlab="day",ylab="%")
dev.off()
...
jpeg(file = " MYR209 index check plot %d.jpeg",quality=100,width = 1200, height = 800,units = 'px', pointsize = 12)
par(mfrow=c(3,3))
