...
for (i in 1:ncol(t))
{
  a <- tsoutliers(t[,i],name = rate_name[i],span=span, percentile = c(0.15,0.85),k=2,range=c(-1,1))
...
jpeg(file = " CNY check plot %d.jpeg",quality=100,width = 800, height = 600,units = 'px', pointsize = 12)
par(mfrow=c(2,2))
