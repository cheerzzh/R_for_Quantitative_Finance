...
for (i in 1:ncol(t))
{
  a <- tsoutliers(t[,i],name = rate_name[i],span=span, percentile = c(0.25,0.75),k=3,range=c(-1,1.2))
...
jpeg(file = " CNY check plot %d.jpeg",quality=100,width = 1200, height = 800,units = 'px', pointsize = 12)
par(mfrow=c(3,3))
