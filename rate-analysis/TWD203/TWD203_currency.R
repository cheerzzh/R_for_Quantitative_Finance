...
index <- read.csv('TWD203_currency.csv',stringsAsFactors = FALSE)
...
jpeg(file = " TWD203 currency LOESS plot %d.jpeg",quality=100,width = 1200, height = 800,units = 'px', pointsize = 12)
...
jpeg(file = "TWD203 currency.jpeg",quality=100,width = 1200,height = 800,units = 'px', pointsize = 12)
...
plot.xts(t, screens = factor(1, 1), panel = custom.panel, auto.legend = TRUE, main = "TWD203 currency")
dev.off()
...
write.csv(data, file = "TWD203_currency_outlier.csv",row.names=TRUE)
